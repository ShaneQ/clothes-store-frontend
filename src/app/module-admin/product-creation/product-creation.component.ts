...
export class ProductCreationComponent implements OnInit {
  ...
  private initializeEmptyForm() {
    this.productForm = this.fb.group({
      ...
      quickDesc: this.getQuickDescriptionControl(''),
      description: this.getDescriptionControl(''),
      fittingInfo: this.getFittingInfoControl(''),
      washInfo: this.getWashInfoControl(''),
      material: this.getMaterialControl(''),
      brand: this.getBrandControl(''),
      imgCover: this.fb.group({
      ...
      measurements: this.fb.group({
        ...
        waist: this.getMeasurementWaistControl("-"),
        length: this.getMeasurementLengthControl("-"),
      }),
      sizes: this.fb.group({
        size1: [false],
        size2: [false],
